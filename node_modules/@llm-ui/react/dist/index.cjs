...
__export(src_exports, {
  stringToTokenArray: () => stringToTokenArray,
  throttleBasic: () => throttleBasic,
  throttleBasicDefaultOptions: () => defaultOptions,
  useLLMOutput: () => useLLMOutput,
  useStreamExample: () => useStreamWithProbabilities,
  useStreamTokenArray: () => useStreamTokenArray,
  useStreamTokenArrayOptionsDefaultOptions: () => useStreamTokenArrayOptionsDefaultOptions,
  useStreamWithProbabilities: () => useStreamWithProbabilities,
  useStreamWithProbabilitiesDefaultOptions: () => useStreamWithProbabilitiesDefaultOptions
});
...
var useLLMOutput = ({
  ...
  const startTime = (0, import_react.useRef)(performance.now());
  const lastRenderTime = (0, import_react.useRef)(performance.now());
  const renderLoopRef = (0, import_react.useRef)();
  const frameRef = (0, import_react.useRef)();
  const frameCountRef = (0, import_react.useRef)(0);
  const finishTimeRef = (0, import_react.useRef)();
  const previousFrameTimeRef = (0, import_react.useRef)();
  const visibleTextAllLengthsRef = (0, import_react.useRef)([]);
  const outputLengthsRef = (0, import_react.useRef)([]);
  const visibleTextIncrementsRef = (0, import_react.useRef)([]);
  const visibleTextLengthTargetRef = (0, import_react.useRef)(0);
  const memoMatchBlocks = (0, import_react.useMemo)(() => {
    return matchBlocks({
      llmOutput,
      blocks,
      fallbackBlock,
  ...
  const [{ blockMatches, ...state }, setState] = (0, import_react.useState)({
    ...initialState,
    finishCount: 0,
...
var useStreamTokenArray = (tokenArray, userOptions) => {
  const nextTokenRef = (0, import_react2.useRef)();
  ...
  const currentIndex = (0, import_react2.useRef)(
  ...
  const [isPlaying, setIsPlaying] = (0, import_react2.useState)(options.autoStart);
  const clearTimeoutRef = (0, import_react2.useRef)(null);
  ...
  const nextToken = (0, import_react2.useCallback)(async () => {
...
var useStreamWithProbabilities = (output, userOptions) => {
  ...
  const tokenArrayRef = (0, import_react3.useRef)(
